                            ...
                            >
                              ...
                              <div className="relative z-10">
                                ...
                                <p className="text-white/90 text-sm leading-tight">
                                  Discover your next stay with us. Whether
                                  you're a host or a guest, we have something
                                  for everyone.
                                </p>
                              </div>
                            </a>
                              ...
                              <NavigationMenuLink asChild>
                                ...
                                >
                                  ...
                                  <div className="text-muted-foreground text-sm">
                                    Create a listing to share your space with
                                    others.
                                  </div>
                                </Link>
                              </NavigationMenuLink>
                      ...
                      <NavigationMenuItem>
                        ...
                        >
                          <Button
                            ...
                            className="flex items-center flex-row text-black gap-2"
                          >
                  ...
                  <div className="mt-6 flow-root">
                    <div className="space-y-2 px-4">
                      ...
                      {!isAuthenticated ? (
                        ...
                        <button
                          onClick={handleLogout}
                          className="flex w-full items-center gap-2 py-2 font-medium hover:text-muted-foreground text-left"
                        >
                          <LogOut className="h-4 w-4" />
                          Logout
                        </button>
